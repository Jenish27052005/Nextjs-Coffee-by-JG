      ...
      <nav aria-label="Global" className="mx-auto flex  items-center justify-between p-6 ">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <Image alt="" src="/images/logo.png" className="" width={190} height={80} />
          </a>
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end items-center gap-5">
          <a href="#" className="text-sm font-semibold leading-6 text-gray-900">
             <ShoppingBagIcon width={35} className='hover:cursor-pointer bg-gray-50 hover:bg-gray-200  p-2 rounded-full shadow-lg shadow-gray-400 hover:scale-105 transition-all'/>
          </a>
